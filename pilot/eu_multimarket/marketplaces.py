...
month names are correct, but NO_DATE_SIGNALS and OUT_OF_STOCK_SIGNALS for
"de" and "fr" are best-effort GUESSES based on how the Swedish/English
site reads — they have NOT been confirmed against real amazon.de /
amazon.fr pages. Validating and correcting these against real output is
the actual point of this pilot; expect early runs to produce "UNKNOWN"
results and debug_*.html dumps until they're tuned.
